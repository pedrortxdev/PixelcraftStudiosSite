...
CREATE DATABASE pixelcraft WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'Portuguese_Brazil.1252';


ALTER DATABASE pixelcraft OWNER TO postgres;
